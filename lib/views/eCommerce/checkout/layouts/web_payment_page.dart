          ...
          bottom: PreferredSize(
            ...
            child: _loadingProgress < 1.0
                ? LinearProgressIndicator(
                    ...
                    backgroundColor: colors(context).primaryColor?.withOpacity(0.3),
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: EcommerceAppColor.green.withOpacity(0.1),
                border: Border(
                  bottom: BorderSide(
                    color: EcommerceAppColor.green.withOpacity(0.3),
                    width: 1,
                  ),
                ),
              ),
            ...
            Expanded(
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: colors(context).dark?.withOpacity(0.1) ?? Colors.black12,
                      blurRadius: 10,
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border(
                  top: BorderSide(
                    color: colors(context).bodyTextSmallColor?.withOpacity(0.2) ?? Colors.grey.withOpacity(0.2),
                    width: 1,
                  ),
                ),
              ),
